...
$GLOBALS['TL_LANG']['tl_calendar_events']['instructorNotes'] = ['Anmerkungen des Event-Leiters', 'Geben Sie hier allfällige Anmerkungen ein. Der Feldinhalt wird im Frontend nicht angezeigt und ist für die interne Verwendung gedacht.'];
...
$GLOBALS['TL_LANG']['tl_calendar_events']['askForAhvNumber'] = ['Im Anmeldeformular zur Eingabe der AHV-Nummer auffordern (JUGEND)', 'Soll beim Anmeldeformular zur Eingabe der AHV-Nummer aufgefordert werden (Touren/Kurse Jugend)?'];
...
$GLOBALS['TL_LANG']['tl_calendar_events']['bookingDetails'] = ['Anmeldung', 'Geben Sie bitte Details oder zusätzlich verlangte Angaben zur Anmeldung an.'];
...
$GLOBALS['TL_LANG']['tl_calendar_events']['eventState'] = ['Event-Status', '<strong class="caution">!!! Teilnehmer müssen separat per E-Mail informiert werden !!!</strong> Geben Sie optional einen Event-Status an.'];
...
$GLOBALS['TL_LANG']['tl_calendar_events']['multiSRC'] = ['Bilder auswählen', '<strong class="caution">!!! Sie müssen die Urheberrechte der Bilder besitzen !!!</strong> Treffen Sie eine Auswahl von Bildern. Evtl. müssen Sie Ihre Bilder zuerst über die Dateiverwaltung auf den Webserver laden.'];
...
$GLOBALS['TL_LANG']['tl_calendar_events']['coordsCH1903'] = ['Ziel-Koordinaten für Kartenansicht (CH1903)', 'Koordinaten des Zieles im Format <q><em><strong>2600000, 1200000</strong></em></q> oder <q><em><strong>600000, 200000</strong></em></q> eingeben. Diese können auf <a href="https://map.geo.admin.ch" rel="noopener" target="_blank"><u><em>map.geo.admin.ch</em></u></a> und einem Klick mit der rechten Maustaste auf das Ziel herausgelesen und kopiert werden.'];
$GLOBALS['TL_LANG']['tl_calendar_events']['journey'] = ['Anreise mit', 'Geben Sie an, wie zum Event angereist wird.'];
$GLOBALS['TL_LANG']['tl_calendar_events']['linkSacRoutePortal'] = ['Link zu SAC-Tourenportal für Routen-Details', 'Link zur Route von SAC-CAS Webseite eingeben. Dieser muss mit <a href="https://www.sac-cas.ch/de/huetten-und-touren/sac-tourenportal/" rel="noopener" target="_blank"><u><em>https://www.sac-cas.ch/de/huetten-und-touren/sac-tourenportal/</em></u></a> beginnen.'];
...
$GLOBALS['TL_LANG']['tl_calendar_events']['filledInEventReportForm'] = ['Tourrapport ausgefüllt', 'Tourrapport wurde ausgefüllt.'];
...
$GLOBALS['TL_LANG']['tl_calendar_events']['noSpecificEventState'] = 'Findet statt/hat stattgefunden';
